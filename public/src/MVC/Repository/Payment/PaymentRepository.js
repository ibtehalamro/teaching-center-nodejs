import { executeQuery, getConnection } from "../../../server/DB_connection.js";
      ...
      con.beginTransaction((error) => {
        ...
        con.query(
          ...
          (error, results) => {
            if (error) {
              con.rollback(() => {
                con.end(); // Release the connection on rollback
                reject(error);
              });
              return;
            }
            ...
            con.query(
              ...
              (error, results) => {
                ...
                con.commit((error) => {
                  ...
                  con.end(); // Release the connection on successful commit
                  resolve();
                });
              }
            );
